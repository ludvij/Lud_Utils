...
template<IntegerType N> N parse_num(const std::string_view sv, int base/*=10*/)
{
	N val{};
...
template<RealType N> N parse_num(const std::string_view sv, const std::chars_format fmt/*=std::chars_format::general)*/)
{
	N val{};
...
template<RealType N> std::optional<N> is_num(const std::string_view sv, const std::chars_format fmt/*=std::chars_format::general)*/)
{
	N val{};
